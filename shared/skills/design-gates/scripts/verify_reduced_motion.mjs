 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/verify_reduced_motion.mjs <file.html | dir> [--threshold=0.1]
...
if (!targets.length) {
  console.log('usage: node $HOME/.claude/skills/design-gates/scripts/verify_reduced_motion.mjs <file.html | dir> [--threshold=0.1]');
  process.exit(0);
}
