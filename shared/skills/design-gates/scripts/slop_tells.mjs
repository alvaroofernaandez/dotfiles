 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/slop_tells.mjs <file.html...> [--dark] [--strict]
...
if (!files.length) { console.log('usage: node $HOME/.claude/skills/design-gates/scripts/slop_tells.mjs <file.html...> [--dark] [--strict]'); process.exit(0); }
