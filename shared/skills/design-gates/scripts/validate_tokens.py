...
Usage:
  python3 $HOME/.claude/skills/design-gates/scripts/validate_tokens.py                    # the engine's tokens/ directory
  python3 $HOME/.claude/skills/design-gates/scripts/validate_tokens.py design-tokens.json # any file or directory
