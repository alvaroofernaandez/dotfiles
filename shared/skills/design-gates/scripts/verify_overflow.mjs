 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/verify_overflow.mjs <file.html | dir> [--widths=320,414,1280]
...
if (!targets.length) {
  console.log('usage: node $HOME/.claude/skills/design-gates/scripts/verify_overflow.mjs <file.html | dir> [--widths=320,414,1280]');
  process.exit(0);
}
