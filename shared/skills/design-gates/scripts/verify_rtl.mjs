 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/verify_rtl.mjs <file.html>
...
if (!file) { console.log('usage: node $HOME/.claude/skills/design-gates/scripts/verify_rtl.mjs <file.html>'); process.exit(0); }
