...
Usage:
  python3 $HOME/.claude/skills/design-gates/scripts/validate_theme_refs.py                          # defaults to examples/golden
  python3 $HOME/.claude/skills/design-gates/scripts/validate_theme_refs.py theme.css src/           # your theme + your code
  python3 $HOME/.claude/skills/design-gates/scripts/validate_theme_refs.py --theme a.css --theme b.css src/
