 ...
 *
 * Usage:
 *   node $HOME/.claude/skills/design-gates/scripts/measure_render.mjs examples/apple-demo/index.html
 *   node $HOME/.claude/skills/design-gates/scripts/measure_render.mjs --dark examples/sample-app/preview.html
 *   node $HOME/.claude/skills/design-gates/scripts/measure_render.mjs            # defaults to examples/ *.html
 *
...
let browser;
try { browser = await chromium.launch({ channel: 'chrome' }).catch(() => chromium.launch()); }
