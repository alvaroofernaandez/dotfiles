...
Usage:
  python3 $HOME/.claude/skills/design-gates/scripts/lint_hardcodes.py src/components            # a dir
  python3 $HOME/.claude/skills/design-gates/scripts/lint_hardcodes.py Button.tsx Card.vue       # files
  python3 $HOME/.claude/skills/design-gates/scripts/lint_hardcodes.py --ext .tsx,.vue src/
