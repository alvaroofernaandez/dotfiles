 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/lint_intent.mjs <file.html | dir> [--dark] [--tolerance=40]
...
if (!targets.length) {
  console.log('usage: node $HOME/.claude/skills/design-gates/scripts/lint_intent.mjs <file.html | dir> [--dark] [--tolerance=40]');
  process.exit(0);
}
