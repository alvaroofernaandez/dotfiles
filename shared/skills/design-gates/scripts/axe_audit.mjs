 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/axe_audit.mjs <file.html> [--dark]
...
if (!file) { console.log('usage: node $HOME/.claude/skills/design-gates/scripts/axe_audit.mjs <file.html> [--dark]'); process.exit(0); }
