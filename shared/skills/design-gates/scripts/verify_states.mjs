 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/verify_states.mjs <file.html> [--dark]
...
if (!file) { console.log('usage: node $HOME/.claude/skills/design-gates/scripts/verify_states.mjs <file.html> [--dark]'); process.exit(0); }
