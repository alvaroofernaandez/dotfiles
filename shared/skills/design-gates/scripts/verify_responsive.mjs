 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/verify_responsive.mjs <file.html | dir> [--widths=280,320,414]
 *                                           [--scale=1.25] [--advisory]
...
if (!target) { console.log('usage: node $HOME/.claude/skills/design-gates/scripts/verify_responsive.mjs <file.html | dir> [--widths=280,320,414]'); process.exit(0); }
