 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/verify_focustrap.mjs <file.html> --open=<triggerSelector> [--dialog=<sel>] [--dark]
...
if (!file || !open) { console.log('usage: node $HOME/.claude/skills/design-gates/scripts/verify_focustrap.mjs <file.html> --open=<trigger> [--dialog=<sel>] [--dark]'); process.exit(0); }
