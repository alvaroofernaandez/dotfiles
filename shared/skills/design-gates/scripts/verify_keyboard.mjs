 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/verify_keyboard.mjs <file.html | dir>
...
if (!targets.length) { console.log('usage: node $HOME/.claude/skills/design-gates/scripts/verify_keyboard.mjs <file.html | dir>'); process.exit(0); }
