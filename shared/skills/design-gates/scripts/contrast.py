...
Usage:
  python3 $HOME/.claude/skills/design-gates/scripts/contrast.py "#1d1d1f" "#ffffff"
  python3 $HOME/.claude/skills/design-gates/scripts/contrast.py 1d1d1f f5f5f7 --large
