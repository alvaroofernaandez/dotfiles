...
Usage:
  python3 $HOME/.claude/skills/design-gates/scripts/check_no_emoji.py                      # examples/ + taste/ + agent files
  python3 $HOME/.claude/skills/design-gates/scripts/check_no_emoji.py path/to/src ...
