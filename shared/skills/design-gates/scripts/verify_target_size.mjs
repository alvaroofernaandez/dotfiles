 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/verify_target_size.mjs <file.html | dir> [--widths=414,1280]
...
if (!targets.length) {
  console.log('usage: node $HOME/.claude/skills/design-gates/scripts/verify_target_size.mjs <file.html | dir> [--widths=414,1280] [--min=24] [--dark]');
  process.exit(0);
}
