...
Usage:
  python3 $HOME/.claude/skills/design-gates/scripts/validate_contrast.py
  python3 $HOME/.claude/skills/design-gates/scripts/validate_contrast.py --aaa            # also report 7:1 (AAA) for body text
  python3 $HOME/.claude/skills/design-gates/scripts/validate_contrast.py design-tokens.json   # any DTCG file of the same shape
