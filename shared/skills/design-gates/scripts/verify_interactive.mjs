 ...
 *
 * Usage: node $HOME/.claude/skills/design-gates/scripts/verify_interactive.mjs <file.html | dir> [--dark] [--advisory]
...
if (!target) {
  console.log('usage: node $HOME/.claude/skills/design-gates/scripts/verify_interactive.mjs <file.html | dir> [--dark] [--advisory]');
  process.exit(0);
}
