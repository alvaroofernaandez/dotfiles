...
- Applying SDD tasks without accidentally producing a PR above 400 production lines.
...
| SDD workload guard | If SDD tasks forecast a >400-production-line change, group commits into chained PR slices before implementation. Test lines never count toward the budget. |
...
4. If the PR approaches 400 production lines, promote commits or groups of commits into chained PRs. Keeping tests with the code they verify never pushes a PR over budget.
